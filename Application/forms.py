...
class AsesorComercialForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['correo', 'telefono', 'cod_sucursal', 'id_usuario']
...
class VehiculoClienteForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['placa', 'marca', 'modelo', 'anio', 'color', 'VIN', 'tipo_combustible', 'id_cliente']

class ClienteForm(forms.ModelForm):
    class Meta:
        model = Cliente
        fields = ['nombre', 'apellido', 'telefono', 'correo', 'direccion', 'id_cliente']
