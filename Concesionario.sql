...
INSERT INTO Application_empleado (id_empleado, nombre, apellido, direccion, fecha_inicio, salario, cargo) 
...
INSERT INTO Application_usuario (id_usuario, id_empleado, contrasena) 
...
INSERT INTO Application_sucursal (cod_sucursal, nombre, direccion, ciudad) 
VALUES (1, 'Sucursal Cali', 'Calle 10', 'Cali'), 
       (2, 'Sucursal Bogota', 'Calle 15', 'Bogota'), 
	   (3, 'Sucursal Medellin', 'Calle 20', 'Medellin');

INSERT INTO Application_jefetaller (id_jefetaller, correo, telefono, cod_sucursal, id_usuario) 
...
INSERT INTO Application_asesorcomercial (id_asesor, correo, telefono, cod_sucursal, id_usuario) 
...
INSERT INTO Application_gerente (id_gerente, correo, telefono, cod_sucursal, id_usuario) 
...
INSERT INTO Application_cliente (nombre, apellido, telefono, correo, direccion, id_cliente) 
...
INSERT INTO Application_vehiculocliente (marca, modelo, anio, color, placa, VIN, tipo_combustible, id_cliente) 
...
INSERT INTO Application_ordenreparacion (numero_orden, id_cliente, placa, descripcion, id_jefetaller, precio, fecha_inicio, fecha_entrega) 
...
INSERT INTO Application_repuestos (referencia_repuesto, cantidad, precioUnitario, descripcion, cod_sucursal) 
...
INSERT INTO Application_vehiculonuevo (VIN, color, marca, modelo, anio, linea, precio, descuento, cod_sucursal)
...
INSERT INTO Application_accesorios (id_accesorio, nombre, descripcion) 
...
INSERT INTO Application_cotizacion (id_cotizacion, fecha_cotizacion, id_cliente, referencia_repuesto, VIN, cod_sucursal, descripcion) 
...
INSERT INTO Application_cotizacionaccesorios (id_cotizacion, id_accesorio) 
VALUES (1, 1), 
       (5, 4), 
	   (8, 5),
	   (11, 2);